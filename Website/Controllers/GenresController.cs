...
namespace Website.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Genre_Id,Genre_Name,ImageFile")] Genre genre)
        {
            if (ModelState.IsValid)
            {
                ...
                genre.Genre_Image = "/Images/" + fileName;

                fileName = Path.Combine(Server.MapPath("~/Images/"), fileName);
                genre.ImageFile.SaveAs(fileName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Genre_Id,Genre_Name,Genre_Image")] Genre genre)
        {
            if (ModelState.IsValid)
            {
                string fileName = Path.GetFileNameWithoutExtension(genre.ImageFile.FileName);
